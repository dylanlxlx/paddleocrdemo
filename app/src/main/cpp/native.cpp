...
Java_com_dylanlxlx_paddleocrdemo_ocr_OCRPredictorNative_init(
...
Java_com_dylanlxlx_paddleocrdemo_ocr_OCRPredictorNative_forward(
...
Java_com_dylanlxlx_paddleocrdemo_ocr_OCRPredictorNative_release(
