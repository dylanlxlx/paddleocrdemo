...
Java_com_jzzh_paddleocr_ocr_OCRPredictorNative_init(
...
Java_com_jzzh_paddleocr_ocr_OCRPredictorNative_forward(
...
Java_com_jzzh_paddleocr_ocr_OCRPredictorNative_release(
